---
title: "Clase Uno: Material de Introducción"
...
-   data: en este directorio vamos a colocar nuestros datos, ejemplo: `.csv, .txt, .json`.

-   docs: en este directorio vamos a colocar todos las documentaciones que se generen o material de referencia, ejemplo: `documentos word, pdf`.

-   graphs: en este directorio vamos a colocar todas las visualizaciones generadas: ejemplo: `.png, .jpg, .jpge.`

-   reports: en este directorio vamos a colocar todos los informes generados, los informes se generan como un archivo `.rmd` y se exportan en un `.html o .pdf`

-   src: en este directorio vamos a colocar todos los \`script de R\`\` que generemos, es decir todos los archivos de codigo R que utilicemos para nuestro análisis.

-   test: en este directorio vamos a colocar todos los experimentos que queramos realizar sobre los datos a modo de prueba.
